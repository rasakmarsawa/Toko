                    ...
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Daftar Item</h2>
                                </div>
                                <div class="col text-end">
                                    <a href="item_new.php" class="btn btn-sm btn-primary">
                                  ...
                                  <?php if ($data): ?>
                                    <?php foreach ($data as $key => $value): ?>
                                      <tr>
                                          ...
                                          <td class="fw-bolder text-gray-500">
                                              <?php echo 'Rp. '.$value['item_price1'].',-' ?>
                                          </td>
                                          <td class="fw-bolder text-gray-500">
                                              <?php echo 'Rp. '.$value['item_price2'].',-' ?>
                                          </td>
                                          <td class="fw-bolder text-gray-500">
                                            <a href="item_detail.php?cat_id=<?php echo $value['category_id'] ?>&&id=<?php echo $value['item_id'] ?>&&cat=<?php echo $value['category_name'] ?>" class="btn btn-sm btn-secondary d-inline-flex align-items-center">
