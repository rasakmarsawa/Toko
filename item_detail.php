                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-end">
                                  ...
                                  <a href="?cat_id=<?php echo $_GET['cat_id'] ?>&&id=<?php echo $_GET['id'] ?>&&delete=1" class="btn btn-sm btn-danger d-inline-flex align-items-center">
                            ...
                            <ul>
                                        ...
                                        <li>Harga
                                            <ul>
                                                ...
                                                <li><?php echo 'Rp. '.$data['item_price2'].',-' ?></li>
                                            </ul>
                                        </li>
                          </ul>
                        </div>
