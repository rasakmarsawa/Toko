...
<li class="nav-item">
<!-- <a href="https://google.com" target="_blank" class="nav-link d-flex align-items-center">
  <span class="sidebar-icon">
    <img src="assets/img/icons/X.png" height="30" width="30" alt="X Logo">
  </span>
  <span class="sidebar-text">X9090</span>
</a> -->
</li>
